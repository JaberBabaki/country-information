...
public class PageIndicator extends ImageView {
    ...
    private static final int CIRCLE_STROKE_COLOR = Color.MAGENTA;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.drawCircle(offsetX + i * (CIRCLE_RADIUS + CIRCLE_SPACE), 20, radius / 2.0f, strokePaint);

            if (canDrawFill) {
                canvas.drawCircle(offsetX + i * (CIRCLE_RADIUS + CIRCLE_SPACE), 20, radius / 2.0f, fillPaint);
            }
        }
    }
